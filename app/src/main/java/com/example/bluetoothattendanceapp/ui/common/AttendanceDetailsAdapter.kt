...
import com.example.bluetoothattendanceapp.ui.teacher.AttendeeInfo

class AttendanceDetailsAdapter : ListAdapter<AttendeeInfo, AttendanceDetailsAdapter.ViewHolder>(
    DIFF_CALLBACK
) {
